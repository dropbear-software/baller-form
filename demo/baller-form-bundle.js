...
`;var Vt=class extends N{};Vt.styles=[io];Vt=l([w("md-checkbox")],Vt);var pt=class extends x{render(){return p`<slot></slot>`}connectedCallback(){if(super.connectedCallback(),this.getAttribute("aria-hidden")==="false"){this.removeAttribute("aria-hidden");return}this.setAttribute("aria-hidden","true")}};var oo=b`:host{font-size:24px;width:24px;height:24px;color:inherit;font-variation-settings:inherit;font-weight:400;font-family:var(--md-icon-font, Material Symbols Outlined);display:inline-flex;font-style:normal;line-height:1;overflow:hidden;letter-spacing:normal;text-transform:none;user-select:none;white-space:nowrap;word-wrap:normal;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;-moz-osx-font-smoothing:grayscale}::slotted(svg){fill:currentColor}::slotted(*){height:100%;width:100%}/*# sourceMappingURL=icon-styles.css.map */
      ...
      <div>
        ...
        <div class="form-fields">
          ...
          <div class="field-with-tooltip">
            ...
            ></md-filled-text-field>
            ${this._renderTooltip(xe.birthday)}
          </div>
          ...
          <div class="field-with-tooltip">
            ...
            ${this._renderTooltip(xe.clothes)}
          </div>
  ...
  `}_renderSocialQuestions(){return p`
      <div>
        ...
        <div class="field-with-tooltip">
          ...
          ${this._renderTooltip(xe.highlight)}
        </div>
          <div class="field-with-tooltip">
          <md-filled-text-field
    ...
    <div class="field-with-tooltip">
      ...
      ${this._renderTooltip(xe.experience)}
    </div>
    ...
    `}};g.styles=[$i];l([s({type:String,attribute:"site-key"})],g.prototype,"captchaSiteKey",void 0);l([s({type:String,attribute:"captcha-endpoint"})],g.prototype,"captchaEndpoint",void 0);l([s({type:String,attribute:"braze-endpoint"})],g.prototype,"brazeEndpoint",void 0);l([f('md-outlined-button[name="apply"]')],g.prototype,"submitButton",void 0);l([f("form#application-form")],g.prototype,"applicationFormElement",void 0);l([f('md-filled-text-field[autocomplete="given-name"]')],g.prototype,"firstName",void 0);l([f('md-filled-text-field[autocomplete="family-name"]')],g.prototype,"familyName",void 0);l([f('md-filled-text-field[autocomplete="email"]')],g.prototype,"email",void 0);l([f('md-filled-text-field[autocomplete="tel"]')],g.prototype,"tel",void 0);l([f('md-filled-text-field[autocomplete="bday"]')],g.prototype,"birthday",void 0);l([f('md-filled-select[name="shirt-size"]')],g.prototype,"shirt",void 0);l([f('md-filled-select[name="experience"]')],g.prototype,"experience",void 0);l([f('md-filled-select[name="bundesland"]')],g.prototype,"bundesland",void 0);l([f('md-filled-select[name="current-country"]')],g.prototype,"currentCountry",void 0);l([f('md-filled-select[name="position"]')],g.prototype,"position",void 0);l([f('md-filled-select[name="active-experience"]')],g.prototype,"activeExperience",void 0);l([f('md-filled-text-field[name="international-current-team-country"]')],g.prototype,"currentInternationalTeamCountry",void 0);l([f('md-filled-text-field[name="current-international-league"]')],g.prototype,"currentInternationalLeague",void 0);l([f('md-filled-select[name="team-type"]')],g.prototype,"teamType",void 0);l([f('md-filled-select[name="spielklasse"]')],g.prototype,"spielklasse",void 0);l([f('md-filled-text-field[name="other-experience"]')],g.prototype,"otherExperience",void 0);l([f('md-filled-select[name="highest-domestic-experience"]')],g.prototype,"highestSpielklasse",void 0);l([f('md-filled-select[name="highest-experience"]')],g.prototype,"highestExperience",void 0);l([f('md-filled-text-field[name="historical-experience-country"]')],g.prototype,"highestExperienceCountry",void 0);l([f('md-filled-text-field[name="historical-experience-league"]')],g.prototype,"highestExperienceLeague",void 0);l([f('md-filled-text-field[name="club"]')],g.prototype,"clubName",void 0);l([f('md-filled-text-field[name="highlight-tape"]')],g.prototype,"highlightTape",void 0);l([f('md-filled-text-field[name="transfermarkt"]')],g.prototype,"transfermarkt",void 0);l([f('md-filled-text-field[name="youtube"]')],g.prototype,"youtube",void 0);l([f('md-filled-text-field[name="instagram"]')],g.prototype,"instagram",void 0);l([f('md-filled-text-field[name="tiktok"]')],g.prototype,"tiktok",void 0);l([f('md-filled-text-field[name="xing"]')],g.prototype,"xing",void 0);l([f('md-filled-text-field[name="freeform"]')],g.prototype,"freeform",void 0);l([f('[data-element="tos"]')],g.prototype,"termsOfServiceBox",void 0);l([f('[data-element="teilnahmebedingungen"]')],g.prototype,"teilnahmebedingungenBox",void 0);l([f('md-dialog[data-reason="success"]')],g.prototype,"successDialog",void 0);l([f('md-dialog[data-reason="error"]')],g.prototype,"errorDialog",void 0);l([A()],g.prototype,"leageOptions",void 0);g=K=l([w("baller-form")],g);})();
