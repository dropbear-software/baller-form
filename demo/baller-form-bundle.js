...
`;var Ao=[{transform:"translateX(0)"},{transform:"translateX(-100vw)"}],Co=[{transform:"translateX(0)"},{transform:"translateX(100vw)"}],$t={duration:500,easing:"ease-in-out",iterations:1},To={...$t,direction:"reverse"},$o=[Ao,$t],So=[Co,$t],ko=[Ao,To],Io=[Co,To];var K={instagram:u`
...
`;var zt=class extends rt{};zt.styles=[ot,tt,Ko];zt=a([x("md-filled-tonal-button")],zt);var T=class extends b{constructor(){super(...arguments),this.disabled=!1,this.error=!1,this.focused=!1,this.label="",this.populated=!1,this.required=!1,this.resizable=!1,this.supportingText="",this.errorText="",this.count=-1,this.max=-1,this.hasStart=!1,this.hasEnd=!1,this.isAnimating=!1,this.refreshErrorAlert=!1,this.disableTransitions=!1}get counterText(){return this.count<0||this.max<0?"":`${this.count} / ${this.max}`}get supportingOrErrorText(){return this.error&&this.errorText?this.errorText:this.supportingText}reannounceError(){this.refreshErrorAlert=!0}update(e){e.has("disabled")&&e.get("disabled")!==void 0&&(this.disableTransitions=!0),this.disabled&&this.focused&&(e.set("focused",!0),this.focused=!1),this.animateLabelIfNeeded({wasFocused:e.get("focused"),wasPopulated:e.get("populated")}),super.update(e)}render(){let e=this.renderLabel(!0),t=this.renderLabel(!1),o=this.renderOutline?.(e),i={disabled:this.disabled,"disable-transitions":this.disableTransitions,error:this.error&&!this.disabled,focused:this.focused,"with-start":this.hasStart,"with-end":this.hasEnd,populated:this.populated,resizable:this.resizable,required:this.required,"no-label":!this.label};return u`
    ...
    `}updateSlottedAriaDescribedBy(){for(let e of this.slottedAriaDescribedBy)Ye(u`${this.supportingOrErrorText} ${this.counterText}`,e),e.setAttribute("hidden","")}renderLabel(e){if(!this.label)return h;let t;e?t=this.focused||this.populated||this.isAnimating:t=!this.focused&&!this.populated&&!this.isAnimating;let o={hidden:!t,floating:e,resting:!e},i=`${this.label}${this.required?"*":""}`;return u`
      <span class="label ${I(o)}"
        aria-hidden=${!t}
      >${i}</span>
    `}animateLabelIfNeeded({wasFocused:e,wasPopulated:t}){if(!this.label)return;e??(e=this.focused),t??(t=this.populated);let o=e||t,i=this.focused||this.populated;o!==i&&(this.isAnimating=!0,this.labelAnimation?.cancel(),this.labelAnimation=this.floatingLabelEl?.animate(this.getLabelKeyframes(),{duration:150,easing:oe.STANDARD}),this.labelAnimation?.addEventListener("finish",()=>{this.isAnimating=!1}))}getLabelKeyframes(){let{floatingLabelEl:e,restingLabelEl:t}=this;if(!e||!t)return[];let{x:o,y:i,height:n}=e.getBoundingClientRect(),{x:s,y:d,height:c}=t.getBoundingClientRect(),p=e.scrollWidth,f=t.scrollWidth,m=f/p,y=s-o,_=d-i+Math.round((c-n*m)/2),P=`translateX(${y}px) translateY(${_}px) scale(${m})`,S="translateX(0) translateY(0) scale(1)",B=t.clientWidth,E=f>B?`${B/m}px`:"";return this.focused||this.populated?[{transform:P,width:E},{transform:S,width:E}]:[{transform:S,width:E},{transform:P,width:E}]}getSurfacePositionClientRect(){return this.containerEl.getBoundingClientRect()}};a([l({type:Boolean})],T.prototype,"disabled",void 0);a([l({type:Boolean})],T.prototype,"error",void 0);a([l({type:Boolean})],T.prototype,"focused",void 0);a([l()],T.prototype,"label",void 0);a([l({type:Boolean})],T.prototype,"populated",void 0);a([l({type:Boolean})],T.prototype,"required",void 0);a([l({type:Boolean})],T.prototype,"resizable",void 0);a([l({attribute:"supporting-text"})],T.prototype,"supportingText",void 0);a([l({attribute:"error-text"})],T.prototype,"errorText",void 0);a([l({type:Number})],T.prototype,"count",void 0);a([l({type:Number})],T.prototype,"max",void 0);a([l({type:Boolean,attribute:"has-start"})],T.prototype,"hasStart",void 0);a([l({type:Boolean,attribute:"has-end"})],T.prototype,"hasEnd",void 0);a([F({slot:"aria-describedby"})],T.prototype,"slottedAriaDescribedBy",void 0);a([C()],T.prototype,"isAnimating",void 0);a([C()],T.prototype,"refreshErrorAlert",void 0);a([C()],T.prototype,"disableTransitions",void 0);a([A(".label.floating")],T.prototype,"floatingLabelEl",void 0);a([A(".label.resting")],T.prototype,"restingLabelEl",void 0);a([A(".container")],T.prototype,"containerEl",void 0);var it=class extends T{renderOutline(e){return u`
      <div class="outline">
...
`;function Ut(r,e=ne){let t=Le(r,e);return t&&(t.tabIndex=0,t.focus()),t}function Ft(r,e=ne){let t=Vt(r,e);return t&&(t.tabIndex=0,t.focus()),t}function de(r,e=ne){for(let t=0;t<r.length;t++){let o=r[t];if(o.tabIndex===0&&e(o))return{item:o,index:t}}return null}function Le(r,e=ne){for(let t of r)if(e(t))return t;return null}function Vt(r,e=ne){for(let t=r.length-1;t>=0;t--){let o=r[t];if(e(o))return o}return null}function Nr(r,e,t=ne){for(let o=1;o<r.length;o++){let i=(o+e)%r.length,n=r[i];if(t(n))return n}return r[e]?r[e]:null}function Ur(r,e,t=ne){for(let o=1;o<r.length;o++){let i=(e-o+r.length)%r.length,n=r[i];if(t(n))return n}return r[e]?r[e]:null}function Ht(r,e,t=ne){if(e){let o=Nr(r,e.index,t);return o&&(o.tabIndex=0,o.focus()),o}else return Ut(r,t)}function qt(r,e,t=ne){if(e){let o=Ur(r,e.index,t);return o&&(o.tabIndex=0,o.focus()),o}else return Ft(r,t)}function ne(r){return!r.disabled}var L={ArrowDown:"ArrowDown",ArrowLeft:"ArrowLeft",ArrowUp:"ArrowUp",ArrowRight:"ArrowRight",Home:"Home",End:"End"},st=class{constructor(e){this.handleKeydown=p=>{let f=p.key;if(p.defaultPrevented||!this.isNavigableKey(f))return;let m=this.items;if(!m.length)return;let y=de(m,this.isActivatable);y&&(y.item.tabIndex=-1),p.preventDefault();let _=this.isRtl(),P=_?L.ArrowRight:L.ArrowLeft,S=_?L.ArrowLeft:L.ArrowRight;switch(f){case L.ArrowDown:case S:Ht(m,y,this.isActivatable);break;case L.ArrowUp:case P:qt(m,y,this.isActivatable);break;case L.Home:Ut(m,this.isActivatable);break;case L.End:Ft(m,this.isActivatable);break;default:break}},this.onDeactivateItems=()=>{let p=this.items;for(let f of p)this.deactivateItem(f)},this.onRequestActivation=p=>{this.onDeactivateItems();let f=p.target;this.activateItem(f),f.focus()},this.onSlotchange=()=>{let p=this.items,f=!1;for(let y of p){if(!y.disabled&&y.tabIndex>-1&&!f){f=!0,y.tabIndex=0;continue}y.tabIndex=-1}if(f)return;let m=Le(p,this.isActivatable);m&&(m.tabIndex=0)};let{isItem:t,getPossibleItems:o,isRtl:i,deactivateItem:n,activateItem:s,isNavigableKey:d,isActivatable:c}=e;this.isItem=t,this.getPossibleItems=o,this.isRtl=i,this.deactivateItem=n,this.activateItem=s,this.isNavigableKey=d,this.isActivatable=c}get items(){let e=this.getPossibleItems(),t=[];for(let o of e){if(this.isItem(o)){t.push(o);continue}let n=o.item;n&&this.isItem(n)&&t.push(n)}return t}activateNextItem(){let e=this.items,t=de(e,this.isActivatable);return t&&(t.item.tabIndex=-1),Ht(e,t,this.isActivatable)}activatePreviousItem(){let e=this.items,t=de(e,this.isActivatable);return t&&(t.item.tabIndex=-1),qt(e,t,this.isActivatable)}};function Fr(r,e){return new CustomEvent("close-menu",{bubbles:!0,composed:!0,detail:{initiator:r,reason:e,itemPath:[r]}})}var Gt=Fr;var jt={SPACE:"Space",ENTER:"Enter"},Kt={CLICK_SELECTION:"click-selection",KEYDOWN:"keydown"},Vr={ESCAPE:"Escape",SPACE:jt.SPACE,ENTER:jt.ENTER};function lt(r){return Object.values(Vr).some(e=>e===r)}function sr(r){return Object.values(jt).some(e=>e===r)}function Me(r,e){let t=new Event("md-contains",{bubbles:!0,composed:!0}),o=[],i=s=>{o=s.composedPath()};return e.addEventListener("md-contains",i),r.dispatchEvent(t),e.removeEventListener("md-contains",i),o.length>0}var ce={NONE:"none",LIST_ROOT:"list-root",FIRST_ITEM:"first-item",LAST_ITEM:"last-item"};var De={END_START:"end-start",END_END:"end-end",START_START:"start-start",START_END:"start-end"},dt=class{constructor(e,t){this.host=e,this.getProperties=t,this.surfaceStylesInternal={display:"none"},this.lastValues={isOpen:!1},this.host.addController(this)}get surfaceStyles(){return this.surfaceStylesInternal}async position(){let{surfaceEl:e,anchorEl:t,anchorCorner:o,surfaceCorner:i,positioning:n,xOffset:s,yOffset:d,repositionStrategy:c}=this.getProperties(),p=o.toLowerCase().trim(),f=i.toLowerCase().trim();if(!e||!t)return;this.surfaceStylesInternal={display:"block",opacity:"0"},this.host.requestUpdate(),await this.host.updateComplete;let m=e.getSurfacePositionClientRect?e.getSurfacePositionClientRect():e.getBoundingClientRect(),y=t.getSurfacePositionClientRect?t.getSurfacePositionClientRect():t.getBoundingClientRect(),[_,P]=f.split("-"),[S,B]=p.split("-"),Z=getComputedStyle(e).direction==="ltr",{blockInset:E,blockOutOfBoundsCorrection:U,surfaceBlockProperty:W}=this.calculateBlock({surfaceRect:m,anchorRect:y,anchorBlock:S,surfaceBlock:_,yOffset:d,positioning:n});if(U){let ue=_==="start"?"end":"start",ye=S==="start"?"end":"start",J=this.calculateBlock({surfaceRect:m,anchorRect:y,anchorBlock:ye,surfaceBlock:ue,yOffset:d,positioning:n});U>J.blockOutOfBoundsCorrection&&(E=J.blockInset,U=J.blockOutOfBoundsCorrection,W=J.surfaceBlockProperty)}let{inlineInset:q,inlineOutOfBoundsCorrection:z,surfaceInlineProperty:ae}=this.calculateInline({surfaceRect:m,anchorRect:y,anchorInline:B,surfaceInline:P,xOffset:s,positioning:n,isLTR:Z});if(z){let ue=P==="start"?"end":"start",ye=B==="start"?"end":"start",J=this.calculateInline({surfaceRect:m,anchorRect:y,anchorInline:ye,surfaceInline:ue,xOffset:s,positioning:n,isLTR:Z});Math.abs(z)>Math.abs(J.inlineOutOfBoundsCorrection)&&(q=J.inlineInset,z=J.inlineOutOfBoundsCorrection,ae=J.surfaceInlineProperty)}c==="move"&&(E=E-U,q=q-z),this.surfaceStylesInternal={display:"block",opacity:"1",[W]:`${E}px`,[ae]:`${q}px`},c==="resize"&&(U&&(this.surfaceStylesInternal.height=`${m.height-U}px`),z&&(this.surfaceStylesInternal.width=`${m.width-z}px`)),this.host.requestUpdate()}calculateBlock(e){let{surfaceRect:t,anchorRect:o,anchorBlock:i,surfaceBlock:n,yOffset:s,positioning:d}=e,c=d==="fixed"?1:0,p=n==="start"?1:0,f=n==="end"?1:0,y=(i!==n?1:0)*o.height+s,_=p*o.top+f*(window.innerHeight-o.bottom),P=Math.abs(Math.min(0,window.innerHeight-_-y-t.height));return{blockInset:c*_+y,blockOutOfBoundsCorrection:P,surfaceBlockProperty:n==="start"?"inset-block-start":"inset-block-end"}}calculateInline(e){let{isLTR:t,surfaceInline:o,anchorInline:i,anchorRect:n,surfaceRect:s,xOffset:d,positioning:c}=e,p=c==="fixed"?1:0,f=t?1:0,m=t?0:1,y=o==="start"?1:0,_=o==="end"?1:0,S=(i!==o?1:0)*n.width+d,B=y*n.left+_*(window.innerWidth-n.right),Z=y*(window.innerWidth-n.right)+_*n.left,E=f*B+m*Z,U=Math.abs(Math.min(0,window.innerWidth-E-S-s.width));return{inlineInset:p*E+S,inlineOutOfBoundsCorrection:U,surfaceInlineProperty:o==="start"?"inset-inline-start":"inset-inline-end"}}hostUpdate(){this.onUpdate()}hostUpdated(){this.onUpdate()}async onUpdate(){let e=this.getProperties(),t=!1;for(let[s,d]of Object.entries(e))if(t=t||d!==this.lastValues[s],t)break;let o=this.lastValues.isOpen!==e.isOpen,i=!!e.anchorEl,n=!!e.surfaceEl;t&&i&&n&&(this.lastValues.isOpen=e.isOpen,e.isOpen?(this.lastValues=e,await this.position(),e.onOpen()):o&&(await e.beforeClose(),this.close(),e.onClose()))}close(){this.surfaceStylesInternal={display:"none"},this.host.requestUpdate()}};var H={INDEX:0,ITEM:1,TEXT:2},ct=class{constructor(e){this.getProperties=e,this.typeaheadRecords=[],this.typaheadBuffer="",this.cancelTypeaheadTimeout=0,this.isTypingAhead=!1,this.lastActiveRecord=null,this.onKeydown=t=>{this.isTypingAhead?this.typeahead(t):this.beginTypeahead(t)},this.endTypeahead=()=>{this.isTypingAhead=!1,this.typaheadBuffer="",this.typeaheadRecords=[]}}get items(){return this.getProperties().getItems()}get active(){return this.getProperties().active}beginTypeahead(e){this.active&&(e.code==="Space"||e.code==="Enter"||e.code.startsWith("Arrow")||e.code==="Escape"||(this.isTypingAhead=!0,this.typeaheadRecords=this.items.map((t,o)=>[o,t,t.typeaheadText.trim().toLowerCase()]),this.lastActiveRecord=this.typeaheadRecords.find(t=>t[H.ITEM].tabIndex===0)??null,this.lastActiveRecord&&(this.lastActiveRecord[H.ITEM].tabIndex=-1),this.typeahead(e)))}typeahead(e){if(e.defaultPrevented)return;if(clearTimeout(this.cancelTypeaheadTimeout),e.code==="Enter"||e.code.startsWith("Arrow")||e.code==="Escape"){this.endTypeahead(),this.lastActiveRecord&&(this.lastActiveRecord[H.ITEM].tabIndex=-1);return}e.code==="Space"&&e.preventDefault(),this.cancelTypeaheadTimeout=setTimeout(this.endTypeahead,this.getProperties().typeaheadBufferTime),this.typaheadBuffer+=e.key.toLowerCase();let t=this.lastActiveRecord?this.lastActiveRecord[H.INDEX]:-1,o=this.typeaheadRecords.length,i=c=>(c[H.INDEX]+o-t)%o,n=this.typeaheadRecords.filter(c=>!c[H.ITEM].disabled&&c[H.TEXT].startsWith(this.typaheadBuffer)).sort((c,p)=>i(c)-i(p));if(n.length===0){clearTimeout(this.cancelTypeaheadTimeout),this.lastActiveRecord&&(this.lastActiveRecord[H.ITEM].tabIndex=-1),this.endTypeahead();return}let s=this.typaheadBuffer.length===1,d;this.lastActiveRecord===n[0]&&s?d=n[1]??n[0]:d=n[0],this.lastActiveRecord&&(this.lastActiveRecord[H.ITEM].tabIndex=-1),this.lastActiveRecord=d,d[H.ITEM].tabIndex=0,d[H.ITEM].focus()}};var Wt=200,lr=new Set([L.ArrowDown,L.ArrowUp,L.Home,L.End]),Hr=new Set([L.ArrowLeft,L.ArrowRight,...lr]);function qr(r=document){let e=r.activeElement;for(;e&&e?.shadowRoot?.activeElement;)e=e.shadowRoot.activeElement;return e}var $=class extends b{get openDirection(){return this.menuCorner.split("_")[0]==="START"?"DOWN":"UP"}get anchorElement(){return this.anchor?this.getRootNode().querySelector(`#${this.anchor}`):this.currentAnchorElement}set anchorElement(e){this.currentAnchorElement=e,this.requestUpdate("anchorElement")}constructor(){super(),this.anchor="",this.positioning="absolute",this.quick=!1,this.hasOverflow=!1,this.open=!1,this.xOffset=0,this.yOffset=0,this.typeaheadDelay=Wt,this.anchorCorner=De.END_START,this.menuCorner=De.START_START,this.stayOpenOnOutsideClick=!1,this.stayOpenOnFocusout=!1,this.skipRestoreFocus=!1,this.defaultFocus=ce.FIRST_ITEM,this.typeaheadActive=!0,this.isSubmenu=!1,this.pointerPath=[],this.isPointerDown=!1,this.openCloseAnimationSignal=Mo(),this.listController=new st({isItem:e=>e.hasAttribute("md-menu-item"),getPossibleItems:()=>this.slotItems,isRtl:()=>getComputedStyle(this).direction==="rtl",deactivateItem:e=>{e.selected=!1,e.tabIndex=-1},activateItem:e=>{e.selected=!0,e.tabIndex=0},isNavigableKey:e=>{if(!this.isSubmenu)return Hr.has(e);let o=getComputedStyle(this).direction==="rtl"?L.ArrowLeft:L.ArrowRight;return e===o?!0:lr.has(e)}}),this.lastFocusedElement=null,this.typeaheadController=new ct(()=>({getItems:()=>this.items,typeaheadBufferTime:this.typeaheadDelay,active:this.typeaheadActive})),this.currentAnchorElement=null,this.internals=Ho(this,this.attachInternals()),this.menuPositionController=new dt(this,()=>({anchorCorner:this.anchorCorner,surfaceCorner:this.menuCorner,surfaceEl:this.surfaceEl,anchorEl:this.anchorElement,positioning:this.positioning,isOpen:this.open,xOffset:this.xOffset,yOffset:this.yOffset,onOpen:this.onOpened,beforeClose:this.beforeClose,onClose:this.onClosed,repositionStrategy:this.hasOverflow?"move":"resize"})),this.handleFocusout=async e=>{if(this.stayOpenOnFocusout||!this.open)return;if(e.relatedTarget){if(Me(e.relatedTarget,this))return;let o=this.anchorElement;if(Me(e.relatedTarget,o)&&this.isPointerDown)return}else if(this.isPointerDown&&this.pointerPath.includes(this))return;let t=this.skipRestoreFocus;this.skipRestoreFocus=!0,this.close(),await this.updateComplete,this.skipRestoreFocus=t},this.onOpened=async()=>{this.lastFocusedElement=qr();let e=this.items,t=de(e);t&&this.defaultFocus!==ce.NONE&&(t.item.tabIndex=-1);let o=!this.quick;switch(this.quick?this.dispatchEvent(new Event("opening")):o=!!await this.animateOpen(),this.defaultFocus){case ce.FIRST_ITEM:let i=Le(e);i&&(i.tabIndex=0,i.focus(),await i.updateComplete);break;case ce.LAST_ITEM:let n=Vt(e);n&&(n.tabIndex=0,n.focus(),await n.updateComplete);break;case ce.LIST_ROOT:this.focus();break;default:case ce.NONE:break}o||this.dispatchEvent(new Event("opened"))},this.beforeClose=async()=>{this.open=!1,this.skipRestoreFocus||this.lastFocusedElement?.focus?.(),this.quick||await this.animateClose()},this.onClosed=()=>{this.quick&&(this.dispatchEvent(new Event("closing")),this.dispatchEvent(new Event("closed")))},this.onWindowPointerdown=e=>{this.isPointerDown=!0,this.pointerPath=e.composedPath()},this.onWindowPointerup=()=>{this.isPointerDown=!1},this.onWindowClick=e=>{if(!this.open)return;let t=e.composedPath();!this.stayOpenOnOutsideClick&&!t.includes(this)&&!t.includes(this.anchorElement)&&(this.open=!1)},!1||(this.internals.role="menu",this.addEventListener("keydown",this.listController.handleKeydown),this.addEventListener("keydown",this.captureKeydown,{capture:!0}),this.addEventListener("focusout",this.handleFocusout))}get items(){return this.listController.items}willUpdate(e){if(e.has("open")){if(this.open){this.removeAttribute("aria-hidden");return}this.setAttribute("aria-hidden","true")}}render(){return this.renderSurface()}renderSurface(){return u`
       <div
          class="menu ${I(this.getSurfaceClasses())}"
          style=${Y(this.menuPositionController.surfaceStyles)}>
        ${this.renderElevation()}
        <div class="items">
     ...
     `}renderMenuItems(){return u`<slot
        ...
        @slotchange=${this.listController.onSlotchange}></slot>`}renderElevation(){return u`<md-elevation part="elevation"></md-elevation>`}getSurfaceClasses(){return{open:this.open,fixed:this.positioning==="fixed","has-overflow":this.hasOverflow}}captureKeydown(e){e.target===this&&!e.defaultPrevented&&lt(e.code)&&(e.preventDefault(),this.close()),this.typeaheadController.onKeydown(e)}async animateOpen(){let e=this.surfaceEl,t=this.slotEl;if(!e||!t)return!0;let o=this.openDirection;this.dispatchEvent(new Event("opening")),e.classList.toggle("animating",!0);let i=this.openCloseAnimationSignal.start(),n=e.offsetHeight,s=o==="UP",d=this.items,c=500,p=50,f=250,m=(c-f)/d.length,y=e.animate([{height:"0px"},{height:`${n}px`}],{duration:c,easing:oe.EMPHASIZED}),_=t.animate([{transform:s?`translateY(-${n}px)`:""},{transform:""}],{duration:c,easing:oe.EMPHASIZED}),P=e.animate([{opacity:0},{opacity:1}],p),S=[];for(let E=0;E<d.length;E++){let U=s?d.length-1-E:E,W=d[U],q=W.animate([{opacity:0},{opacity:1}],{duration:f,delay:m*E});W.classList.toggle("md-menu-hidden",!0),q.addEventListener("finish",()=>{W.classList.toggle("md-menu-hidden",!1)}),S.push([W,q])}let B=E=>{},Z=new Promise(E=>{B=E});return i.addEventListener("abort",()=>{y.cancel(),_.cancel(),P.cancel(),S.forEach(([E,U])=>{E.classList.toggle("md-menu-hidden",!1),U.cancel()}),B(!0)}),y.addEventListener("finish",()=>{e.classList.toggle("animating",!1),this.openCloseAnimationSignal.finish(),B(!1)}),await Z}animateClose(){let e,t,o=new Promise((z,ae)=>{e=z,t=ae}),i=this.surfaceEl,n=this.slotEl;if(!i||!n)return t(),o;let d=this.openDirection==="UP";this.dispatchEvent(new Event("closing")),i.classList.toggle("animating",!0);let c=this.openCloseAnimationSignal.start(),p=i.offsetHeight,f=this.items,m=150,y=50,_=m-y,P=50,S=50,B=.35,Z=(m-S-P)/f.length,E=i.animate([{height:`${p}px`},{height:`${p*B}px`}],{duration:m,easing:oe.EMPHASIZED_ACCELERATE}),U=n.animate([{transform:""},{transform:d?`translateY(-${p*(1-B)}px)`:""}],{duration:m,easing:oe.EMPHASIZED_ACCELERATE}),W=i.animate([{opacity:1},{opacity:0}],{duration:y,delay:_}),q=[];for(let z=0;z<f.length;z++){let ae=d?z:f.length-1-z,ue=f[ae],ye=ue.animate([{opacity:1},{opacity:0}],{duration:P,delay:S+Z*z});ye.addEventListener("finish",()=>{ue.classList.toggle("md-menu-hidden",!0)}),q.push([ue,ye])}return c.addEventListener("abort",()=>{E.cancel(),U.cancel(),W.cancel(),q.forEach(([z,ae])=>{ae.cancel(),z.classList.toggle("md-menu-hidden",!1)}),t()}),E.addEventListener("finish",()=>{i.classList.toggle("animating",!1),q.forEach(([z])=>{z.classList.toggle("md-menu-hidden",!1)}),this.openCloseAnimationSignal.finish(),this.dispatchEvent(new Event("closed")),e(!0)}),o}connectedCallback(){super.connectedCallback(),!1||(window.addEventListener("click",this.onWindowClick,{capture:!0}),window.addEventListener("pointerdown",this.onWindowPointerdown),window.addEventListener("pointerup",this.onWindowPointerup))}disconnectedCallback(){super.disconnectedCallback(),!1||(window.removeEventListener("click",this.onWindowClick,{capture:!0}),window.removeEventListener("pointerdown",this.onWindowPointerdown),window.removeEventListener("pointerup",this.onWindowPointerup))}onCloseMenu(){this.close()}onDeactivateItems(e){e.stopPropagation(),this.listController.onDeactivateItems()}onRequestActivation(e){e.stopPropagation(),this.listController.onRequestActivation(e)}handleDeactivateTypeahead(e){e.stopPropagation(),this.typeaheadActive=!1}handleActivateTypeahead(e){e.stopPropagation(),this.typeaheadActive=!0}handleStayOpenOnFocusout(e){e.stopPropagation(),this.stayOpenOnFocusout=!0}handleCloseOnFocusout(e){e.stopPropagation(),this.stayOpenOnFocusout=!1}close(){this.open=!1,this.slotItems.forEach(t=>{t.close?.()})}show(){this.open=!0}activateNextItem(){return this.listController.activateNextItem()??null}activatePreviousItem(){return this.listController.activatePreviousItem()??null}};Vo($,{focusable:!1});a([A(".menu")],$.prototype,"surfaceEl",void 0);a([A("slot")],$.prototype,"slotEl",void 0);a([l()],$.prototype,"anchor",void 0);a([l()],$.prototype,"positioning",void 0);a([l({type:Boolean})],$.prototype,"quick",void 0);a([l({type:Boolean,attribute:"has-overflow"})],$.prototype,"hasOverflow",void 0);a([l({type:Boolean,reflect:!0})],$.prototype,"open",void 0);a([l({type:Number,attribute:"x-offset"})],$.prototype,"xOffset",void 0);a([l({type:Number,attribute:"y-offset"})],$.prototype,"yOffset",void 0);a([l({type:Number,attribute:"typeahead-delay"})],$.prototype,"typeaheadDelay",void 0);a([l({attribute:"anchor-corner"})],$.prototype,"anchorCorner",void 0);a([l({attribute:"menu-corner"})],$.prototype,"menuCorner",void 0);a([l({type:Boolean,attribute:"stay-open-on-outside-click"})],$.prototype,"stayOpenOnOutsideClick",void 0);a([l({type:Boolean,attribute:"stay-open-on-focusout"})],$.prototype,"stayOpenOnFocusout",void 0);a([l({type:Boolean,attribute:"skip-restore-focus"})],$.prototype,"skipRestoreFocus",void 0);a([l({attribute:"default-focus"})],$.prototype,"defaultFocus",void 0);a([F({flatten:!0})],$.prototype,"slotItems",void 0);a([C()],$.prototype,"typeaheadActive",void 0);var dr=v`:host{--md-elevation-level: var(--md-menu-container-elevation, 2);--md-elevation-shadow-color: var(--md-menu-container-shadow-color, var(--md-sys-color-shadow, #000));min-width:112px;color:unset;display:contents}md-focus-ring{--md-focus-ring-shape: var(--md-menu-container-shape, 4px)}.menu{border-radius:var(--md-menu-container-shape, 4px);display:none;opacity:0;z-index:20;position:absolute;user-select:none;max-height:inherit;height:inherit;min-width:inherit;max-width:inherit}.fixed{position:fixed}.items{display:block;list-style-type:none;margin:0;outline:none;box-sizing:border-box;background-color:var(--md-menu-container-color, var(--md-sys-color-surface-container, #f3edf7));height:inherit;max-height:inherit;overflow:auto;min-width:inherit;max-width:inherit;border-radius:inherit}.item-padding{padding-block:8px}.has-overflow .items{overflow:visible}.animating .items{overflow:hidden}.has-overflow.animating .items{pointer-events:none}.animating ::slotted(.md-menu-hidden){opacity:0}slot{display:block;height:inherit;max-height:inherit}::slotted(:is(md-divider,[role=separator])){margin:8px 0}/*# sourceMappingURL=menu-styles.css.map */
...
`;var Ce=class extends b{constructor(){super(...arguments),this.multiline=!1}render(){return u`
...
`;var Zt=class extends Ce{};Zt.styles=[vr];Zt=a([x("md-item")],Zt);var ht=class{constructor(e,t){this.host=e,this.internalTypeaheadText=null,this.onClick=()=>{this.host.keepOpen||this.host.dispatchEvent(Gt(this.host,{kind:Kt.CLICK_SELECTION}))},this.onKeydown=i=>{if(this.host.keepOpen||i.defaultPrevented)return;let n=i.code;!i.defaultPrevented&&lt(n)&&(i.preventDefault(),this.host.dispatchEvent(Gt(this.host,{kind:Kt.KEYDOWN,key:n})))};let{getHeadlineElements:o}=t;this.getHeadlineElements=o,this.host.addController(this)}get typeaheadText(){if(this.internalTypeaheadText!==null)return this.internalTypeaheadText;let e=this.getHeadlineElements(),t=[];return e.forEach(o=>{o.textContent&&o.textContent.trim()&&t.push(o.textContent.trim())}),t.join(" ")}get tagName(){switch(this.host.type){case"link":return"a";case"button":return"button";default:case"menuitem":case"option":return"li"}}get role(){return this.host.type==="option"?"option":"menuitem"}hostConnected(){this.host.toggleAttribute("md-menu-item",!0)}hostUpdate(){this.host.href&&(this.host.type="link")}setTypeaheadText(e){this.internalTypeaheadText=e}};function Gr(){return new Event("request-selection",{bubbles:!0,composed:!0})}function Kr(){return new Event("request-deselection",{bubbles:!0,composed:!0})}var mt=class{get role(){return this.menuItemController.role}get typeaheadText(){return this.menuItemController.typeaheadText}setTypeaheadText(e){this.menuItemController.setTypeaheadText(e)}get displayText(){if(this.internalDisplayText!==null)return this.internalDisplayText;let e=this.getHeadlineElements(),t=[];return e.forEach(o=>{o.textContent&&o.textContent.trim()&&t.push(o.textContent.trim())}),t.join(" ")}setDisplayText(e){this.internalDisplayText=e}constructor(e,t){this.host=e,this.internalDisplayText=null,this.lastSelected=this.host.selected,this.firstUpdate=!0,this.onClick=()=>{this.menuItemController.onClick()},this.onKeydown=o=>{this.menuItemController.onKeydown(o)},this.menuItemController=new ht(e,t),this.getHeadlineElements=t.getHeadlineElements,e.addController(this)}hostUpdate(){this.lastSelected!==this.host.selected&&(this.host.ariaSelected=this.host.selected?"true":"false")}hostUpdated(){this.lastSelected!==this.host.selected&&!this.firstUpdate&&(this.host.selected?this.host.dispatchEvent(Gr()):this.host.dispatchEvent(Kr())),this.lastSelected=this.host.selected,this.firstUpdate=!1}};var V=class extends b{constructor(){super(...arguments),this.disabled=!1,this.isMenuItem=!0,this.selected=!1,this.value="",this.type="option",this.selectOptionController=new mt(this,{getHeadlineElements:()=>this.headlineElements})}get typeaheadText(){return this.selectOptionController.typeaheadText}set typeaheadText(e){this.selectOptionController.setTypeaheadText(e)}get displayText(){return this.selectOptionController.displayText}set displayText(e){this.selectOptionController.setDisplayText(e)}render(){return this.renderListItem(u`
    ...
    `}focus(){this.listItemRoot?.focus()}};j(V);V.shadowRootOptions={...b.shadowRootOptions,delegatesFocus:!0};a([l({type:Boolean,reflect:!0})],V.prototype,"disabled",void 0);a([l({type:Boolean,attribute:"md-menu-item",reflect:!0})],V.prototype,"isMenuItem",void 0);a([l({type:Boolean})],V.prototype,"selected",void 0);a([l()],V.prototype,"value",void 0);a([A(".list-item")],V.prototype,"listItemRoot",void 0);a([F({slot:"headline"})],V.prototype,"headlineElements",void 0);a([l({attribute:"typeahead-text"})],V.prototype,"typeaheadText",null);a([l({attribute:"display-text"})],V.prototype,"displayText",null);var Jt=class extends V{};Jt.styles=[fr,mr];Jt=a([x("md-select-option")],Jt);var O,X=O=class extends b{constructor(){super(...arguments),this.slideIndex=0,this.containerHeight=0}render(){let e={height:`${this.containerHeight}px`};return u`
      <section id="form-wrapper">
        <form>
          ...
          <div class="slides-container" style="${Y(e)}">
            ${this._renderStepOne()}
            ${this._renderStepTwo()}
    ...
    `}firstUpdated(){this.containerHeight=O.getMaxElHeight(this.slideElements),this.initializeSlides(),this.dispatchEvent(new CustomEvent("signup-form-displayed",{bubbles:!0}))}updated(e){if(e.has("slideIndex")){let t=e.get("slideIndex");if(t===void 0)return;this.slideIndex>t?this.navigateWithAnimation(1,$o,Io):this.navigateWithAnimation(-1,So,ko)}}navigateToNextSlide(){let e=this.slideElements[this.slideIndex];if(O.isSlideDataValid(e)){this.slideIndex+=1;let o=new CustomEvent("next-form-step",{detail:{step:this.slideIndex+1},bubbles:!0});this.dispatchEvent(o)}}navigateToPrevSlide(){this.slideIndex-=1;let e=new CustomEvent("prev-form-step",{detail:{step:this.slideIndex+1},bubbles:!0});this.dispatchEvent(e)}static isSlideDataValid(e){return Array.from(e.querySelectorAll(".form-fields > *")).every(i=>"willValidate"in i&&"reportValidity"in i?(i.reportValidity(),i.checkValidity()):!0)}get wrappedIndex(){return O.wrapIndex(this.slideIndex,this.slideElements.length)}static wrapIndex(e,t){return(e%t+t)%t}static showSlide(e){e.classList.remove("slide-hidden")}static hideSlide(e){e.classList.add("slide-hidden")}static getMaxElHeight(e){let t=Array.from(e).map(o=>o.getBoundingClientRect().height);return Math.max(0,...t)}async navigateWithAnimation(e,t,o){this.initializeSlides();let i=O.wrapIndex(this.slideIndex-e,this.slideElements.length),n=this.slideElements[i];O.showSlide(n);let s=n.animate(t[0],t[1]),d=this.slideElements[this.wrappedIndex];O.showSlide(d);let c=d.animate(o[0],o[1]);try{await Promise.all([s.finished,c.finished]),O.hideSlide(n)}catch{}}initializeSlides(){for(let e=0;e<this.slideElements.length;e++){let t=this.slideElements[e];t.getAnimations().forEach(o=>o.cancel()),e===this.wrappedIndex?O.showSlide(t):O.hideSlide(t)}}_handleSubmission(e){e.preventDefault(),this.formElement.checkValidity()&&(this.dispatchEvent(new CustomEvent("completed-application",{bubbles:!0})),this.formElement.submit())}handleLegalChange(){this.termsOfServiceBox.checked?this.submitButton.disabled=!1:this.submitButton.disabled=!0}_renderStepOne(){return u`
    <div class="form-container" data-slide="1">
      ...
      <div class="form-footer">
        <md-filled-button trailing-icon @click=${this.navigateToNextSlide} type="button">Weiter ${K.forwardArrow}</md-filled-button>
      </div>
    </div>
    ...
    <div class="form-container slide-hidden" data-slide="2">
      ...
      <div class="form-footer">
        <md-filled-button trailing-icon @click=${this.navigateToNextSlide} type="button">Weiter ${K.forwardArrow}</md-filled-button>
        <md-filled-tonal-button @click=${this.navigateToPrevSlide} type="button">Back ${K.backArrow}</md-filled-tonal-button>
      </div>
    </div>
    ...
    <div class="form-container slide-hidden" data-slide="4">
      ...
      <div class="form-footer">
        <md-filled-button trailing-icon @click=${this._handleSubmission} type="submit" disabled>Absenden ${K.send}</md-filled-button>
        <md-filled-tonal-button @click=${this.navigateToPrevSlide} type="button">Back ${K.backArrow}</md-filled-tonal-button>
      </div>
    </div>
    `}};X.styles=[wo,Eo];a([l({type:Number})],X.prototype,"slideIndex",void 0);a([C()],X.prototype,"containerHeight",void 0);a([A('md-filled-button[type="submit"]')],X.prototype,"submitButton",void 0);a([A("form")],X.prototype,"formElement",void 0);a([A('[data-element="tos"]')],X.prototype,"termsOfServiceBox",void 0);a([Xe("[data-slide]")],X.prototype,"slideElements",void 0);X=O=a([x("baller-form")],X);})();
