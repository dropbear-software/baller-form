...
`;var ii=class extends Ct{};ii.styles=[Pe,bo];ii=a([I("md-outlined-button")],ii);var M=class extends C{constructor(){super(...arguments),this.disabled=!1,this.error=!1,this.focused=!1,this.label="",this.populated=!1,this.required=!1,this.resizable=!1,this.supportingText="",this.errorText="",this.count=-1,this.max=-1,this.hasStart=!1,this.hasEnd=!1,this.isAnimating=!1,this.refreshErrorAlert=!1,this.disableTransitions=!1}get counterText(){return this.count<0||this.max<0?"":`${this.count} / ${this.max}`}get supportingOrErrorText(){return this.error&&this.errorText?this.errorText:this.supportingText}reannounceError(){this.refreshErrorAlert=!0}update(e){e.has("disabled")&&e.get("disabled")!==void 0&&(this.disableTransitions=!0),this.disabled&&this.focused&&(e.set("focused",!0),this.focused=!1),this.animateLabelIfNeeded({wasFocused:e.get("focused"),wasPopulated:e.get("populated")}),super.update(e)}render(){let e=this.renderLabel(!0),t=this.renderLabel(!1),i=this.renderOutline?.(e),r={disabled:this.disabled,"disable-transitions":this.disableTransitions,error:this.error&&!this.disabled,focused:this.focused,"with-start":this.hasStart,"with-end":this.hasEnd,populated:this.populated,resizable:this.resizable,required:this.required,"no-label":!this.label};return m`
    ...
    `}updateSlottedAriaDescribedBy(){for(let e of this.slottedAriaDescribedBy)ft(m`${this.supportingOrErrorText} ${this.counterText}`,e),e.setAttribute("hidden","")}renderLabel(e){if(!this.label)return g;let t;e?t=this.focused||this.populated||this.isAnimating:t=!this.focused&&!this.populated&&!this.isAnimating;let i={hidden:!t,floating:e,resting:!e},r=`${this.label}${this.required?"*":""}`;return m`
      <span class="label ${q(i)}"
        aria-hidden=${!t}
      >${r}</span>
    `}animateLabelIfNeeded({wasFocused:e,wasPopulated:t}){if(!this.label)return;e??(e=this.focused),t??(t=this.populated);let i=e||t,r=this.focused||this.populated;i!==r&&(this.isAnimating=!0,this.labelAnimation?.cancel(),this.labelAnimation=this.floatingLabelEl?.animate(this.getLabelKeyframes(),{duration:150,easing:ee.STANDARD}),this.labelAnimation?.addEventListener("finish",()=>{this.isAnimating=!1}))}getLabelKeyframes(){let{floatingLabelEl:e,restingLabelEl:t}=this;if(!e||!t)return[];let{x:i,y:r,height:l}=e.getBoundingClientRect(),{x:s,y:h,height:f}=t.getBoundingClientRect(),v=e.scrollWidth,x=t.scrollWidth,b=x/v,w=s-i,k=h-r+Math.round((f-l*b)/2),P=`translateX(${w}px) translateY(${k}px) scale(${b})`,R="translateX(0) translateY(0) scale(1)",B=t.clientWidth,O=x>B?`${B/b}px`:"";return this.focused||this.populated?[{transform:P,width:O},{transform:R,width:O}]:[{transform:R,width:O},{transform:P,width:O}]}getSurfacePositionClientRect(){return this.containerEl.getBoundingClientRect()}};a([p({type:Boolean})],M.prototype,"disabled",void 0);a([p({type:Boolean})],M.prototype,"error",void 0);a([p({type:Boolean})],M.prototype,"focused",void 0);a([p()],M.prototype,"label",void 0);a([p({type:Boolean})],M.prototype,"populated",void 0);a([p({type:Boolean})],M.prototype,"required",void 0);a([p({type:Boolean})],M.prototype,"resizable",void 0);a([p({attribute:"supporting-text"})],M.prototype,"supportingText",void 0);a([p({attribute:"error-text"})],M.prototype,"errorText",void 0);a([p({type:Number})],M.prototype,"count",void 0);a([p({type:Number})],M.prototype,"max",void 0);a([p({type:Boolean,attribute:"has-start"})],M.prototype,"hasStart",void 0);a([p({type:Boolean,attribute:"has-end"})],M.prototype,"hasEnd",void 0);a([Q({slot:"aria-describedby"})],M.prototype,"slottedAriaDescribedBy",void 0);a([$()],M.prototype,"isAnimating",void 0);a([$()],M.prototype,"refreshErrorAlert",void 0);a([$()],M.prototype,"disableTransitions",void 0);a([y(".label.floating")],M.prototype,"floatingLabelEl",void 0);a([y(".label.resting")],M.prototype,"restingLabelEl",void 0);a([y(".container")],M.prototype,"containerEl",void 0);var Tt=class extends M{renderBackground(){return m`
...
`;var wi=class extends N{};wi.styles=[Wo];wi=a([I("md-dialog")],wi);var ae,A=ae=class extends C{static get formAssociated(){return!0}constructor(){super(),this.captchaSiteKey="RECAPTCHA-SITE-KEY",this.captchaEndpoint="/ballerleague/v1/spam_check",this.brazeEndpoint="/ballerleague/v1/submit_application",this.leageOptions=this._renderMensLeagueDropdown(),this.noExperience=!1,this._submissionTask=new qe(this,{task:async()=>{if(this._enrollmentService&&this._spamService){if(await this._spamService.isValidUser()){let t=this._normalizeData();return await this._enrollmentService.process(t)}throw new Error("Failed reCAPTCHA check")}throw new Error("ApplicationData, SpamService or EnrollmentService fields not set")}}),this._internals=this.attachInternals()}static _reportFieldValidity(e){e.target.reportValidity()}firstUpdated(){this._initializeServices(),this.dispatchEvent(new CustomEvent("signup-form-displayed",{bubbles:!0}))}render(){return m`
      ...
      <div>
        ...
        <div class="form-fields">
          ...
          <div class="field-with-tooltip">
            ...
            ></md-filled-text-field>
            ${this._renderTooltip(yt.birthday)}
          </div>
  ...
  `}_renderCountryOptions(){return m`
    ...
    `}_renderSocialQuestions(){return m`
      <div>
        ...
        <div class="field-with-tooltip">
          ...
          ${this._renderTooltip(yt.highlight)}
        </div>
          <div class="field-with-tooltip">
          <md-filled-text-field
          ...
          <div class="field-with-tooltip">
            ...
            ${this._renderTooltip(yt.achievments)}
          </div>
    ...
    `}};A.styles=[eo];a([p({type:String,attribute:"site-key"})],A.prototype,"captchaSiteKey",void 0);a([p({type:String,attribute:"captcha-endpoint"})],A.prototype,"captchaEndpoint",void 0);a([p({type:String,attribute:"braze-endpoint"})],A.prototype,"brazeEndpoint",void 0);a([y('md-outlined-button[name="apply"]')],A.prototype,"submitButton",void 0);a([y("form#application-form")],A.prototype,"applicationFormElement",void 0);a([y('md-filled-text-field[autocomplete="given-name"]')],A.prototype,"firstName",void 0);a([y('md-filled-text-field[autocomplete="family-name"]')],A.prototype,"familyName",void 0);a([y('md-filled-text-field[autocomplete="email"]')],A.prototype,"email",void 0);a([y('md-filled-text-field[autocomplete="tel"]')],A.prototype,"tel",void 0);a([y('md-filled-text-field[autocomplete="bday"]')],A.prototype,"birthday",void 0);a([y('md-filled-select[name="shirt-size"]')],A.prototype,"shirt",void 0);a([y('md-filled-select[name="experience"]')],A.prototype,"experience",void 0);a([y('md-filled-select[name="bundesland"]')],A.prototype,"bundesland",void 0);a([y('md-filled-select[name="current-country"]')],A.prototype,"currentCountry",void 0);a([y('md-filled-select[name="position"]')],A.prototype,"position",void 0);a([y('md-filled-select[name="active-experience"]')],A.prototype,"activeExperience",void 0);a([y('md-filled-select[name="international-current-team-country"]')],A.prototype,"currentInternationalTeamCountry",void 0);a([y('md-filled-text-field[name="current-international-league"]')],A.prototype,"currentInternationalLeague",void 0);a([y('md-filled-select[name="team-type"]')],A.prototype,"teamType",void 0);a([y('md-filled-select[name="spielklasse"]')],A.prototype,"spielklasse",void 0);a([y('md-filled-text-field[name="other-experience"]')],A.prototype,"otherExperience",void 0);a([y('md-filled-text-field[name="domestic-historical-experience-league"]')],A.prototype,"otherDomesticLeague",void 0);a([y('md-filled-select[name="highest-domestic-experience"]')],A.prototype,"highestSpielklasse",void 0);a([y('md-filled-select[name="highest-experience"]')],A.prototype,"highestExperience",void 0);a([y('md-filled-text-field[name="historical-experience-country"]')],A.prototype,"highestExperienceCountry",void 0);a([y('md-filled-text-field[name="historical-experience-league"]')],A.prototype,"highestExperienceLeague",void 0);a([y('md-filled-text-field[name="club"]')],A.prototype,"clubName",void 0);a([y('md-filled-text-field[name="highlight-tape"]')],A.prototype,"highlightTape",void 0);a([y('md-filled-text-field[name="transfermarkt"]')],A.prototype,"transfermarkt",void 0);a([y('md-filled-text-field[name="youtube"]')],A.prototype,"youtube",void 0);a([y('md-filled-text-field[name="instagram"]')],A.prototype,"instagram",void 0);a([y('md-filled-text-field[name="tiktok"]')],A.prototype,"tiktok",void 0);a([y('md-filled-text-field[name="xing"]')],A.prototype,"xing",void 0);a([y('md-filled-text-field[name="freeform"]')],A.prototype,"freeform",void 0);a([y('[data-element="tos"]')],A.prototype,"termsOfServiceBox",void 0);a([y('md-dialog[data-reason="success"]')],A.prototype,"successDialog",void 0);a([y('md-dialog[data-reason="error"]')],A.prototype,"errorDialog",void 0);a([$()],A.prototype,"leageOptions",void 0);a([$()],A.prototype,"noExperience",void 0);A=ae=a([I("baller-form")],A);})();
